...
$tabControl = new CAdminForm("hlrow_edit", $aTabs);
...
if ((strlen($save)>0 || strlen($apply)>0) && $REQUEST_METHOD=="POST" && check_bitrix_sessid())
{
	...
	$USER_FIELD_MANAGER->checkFields('HLBLOCK_'.$hlblock['ID'], null, $data);
...
?>
	...
	<?=$tabControl->ShowUserFields('HLBLOCK_'.$hlblock['ID'], $ID, true);?>
